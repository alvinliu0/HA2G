...
class Config:
    ...
    EXPOSE_BASE_DIR = "/mnt/lustre/liuxian/expose/"
    OPENPOSE_BASE_DIR = "/mnt/lustre/liuxian/openpose/"
    OPENPOSE_BIN_PATH = "/mnt/lustre/liuxian/openpose/build/examples/openpose/openpose.bin"


class TEDConfig(Config):
    YOUTUBE_CHANNEL_ID = "UCAuUUnT6oDeKwE6v1NGQxug"
    WORK_PATH = '/mnt/lustre/liuxian/final'
    CLIP_PATH = WORK_PATH + "/clip_ted"
    VIDEO_PATH = WORK_PATH + "/videos_ted"
    SKELETON_PATH = WORK_PATH + "/skeleton_ted"
    GENTLE_PATH = WORK_PATH + '/gentle_ted'
    AUDIO_PATH = WORK_PATH + '/audio_ted'
    SUBTITLE_PATH = WORK_PATH + 'sub_ted'
    OUTPUT_PATH = WORK_PATH + "/whole_output"
